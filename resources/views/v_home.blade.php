						...
						<nav class="navbar navbar-expand-lg">
							...
							<div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
								<ul id="nav" class="navbar-nav ml-auto">
									...
									<li class="nav-item">
										<a class="" href="/tutorial">How it Works</a>
									</li>
									<li class="nav-item">
			...
			<div class="row align-items-center">
				<div class="col-lg-6">
					<div class="hero-content">
						...
						<div class="hero-btns">
							<a href="/user/add" class="main-btn btn-hover wow fadeInUp"
				...
				<div class="col-lg-6">
					<div class="hero-img wow fadeInUp" data-wow-delay=".5s">
						<img src="{{asset('user_template')}}/assets/img/hero/hero-img.png" alt="">
					</div>
				</div>
			</div>
		</div>
		<div class="hero-shape">
			<img src="{{asset('user_template')}}/assets/img/hero/hero-shape-1.svg" alt="" class="shape shape-1">
		</div>
	</section>
	<!-- ========================= hero-section end ========================= -->
			...
			<div class="row justify-content-center">
				<div class="col-xxl-5 col-xl-6 col-lg-7">
					<div class="section-title text-center mb-30">
						...
						<p class="wow fadeInUp" data-wow-delay=".4s">Lorem ipsum dolor samet consetetur sadipscing
							elitr, serewd diam nonumy eirmod tempor invidunt ut labore.</p>
					</div>
				</div>
			</div>
			...
			<div class="row justify-content-center">
				<div class="col-lg-4 col-md-8 col-sm-10">
					<div class="single-feature">
						...
						<div class="content">
							<h3>Easy To Use</h3>
							<p>Lorem ipsum dolor samet consetet sadip scing elitr serewd diam nonumy eirmod tempor
